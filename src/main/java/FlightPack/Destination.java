...
public enum Destination {
    BERLIN("Berlin","src/main/resources/BerlinerFlughafenDateTimeSheet.csv",2.5),HAMBURG("Hamburg","src/main/resources/HamburgFlughafenDateTimeSheet.csv",1.4),DRESDEN("Dresden","src/main/resources/DresdenFlughafenDateTimeSheet.csv",1.3);
